...
export default {
  ...
  //             }
  //             console.log('this text contain paddy', this.containsPaddy(x))
  //             if (this.containsPaddy(x)) {
  //               const paddy = this.handleText(x)
  //               if (paddy === 'Travel') {
  //                 this.TravelPlan()
  //                 console.log('travel section')
  //               }else if (paddy === 'Gadget') {
  //                 this.GadgetPlan()
  //                 console.log('gadget section')
  //               } else {
  ...
  methods: {
    ...
    TravelPlan() {
      const targetRoute = '/travel';
      if (this.$route.path !== targetRoute) {
        this.$router.push(targetRoute);
      } else {
        console.log('Already on the /travel route');
      }
      this.$store.commit('setTravelModal', true)
    },
    GadgetPlan() {
      const targetRoute = '/gadgets';
      if (this.$route.path !== targetRoute) {
        this.$router.push(targetRoute);
      } else {
        console.log('Already on the /gadget route');
      }
      this.$store.commit('setGadgetModal', true)
    },
    async healthPlan(type) {
      ...
      await axios({url: `${baseURL}/hmo/plans`, method: 'GET'})
          .then(res => {
            ...
            console.log('dddd', filteredObjects);
