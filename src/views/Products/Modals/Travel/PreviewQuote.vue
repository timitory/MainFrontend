        ...
        <div>
          ...
          <div class="lg:px-8 px-4 py-7 ">
            <div class="flex flex-wrap gap-y-6 justify-between">
              ...
              <div class="w-1/3">
                <p class="font-bold lg:text-sm text-xs">
                  <span class="font-bold capitalize block">Multi Trip</span>
                  <span class="font-bold">{{ quoteDetails.is_multi_trip }}</span>
                </p>
              </div>
              <div class="w-1/3">
                <p class="font-bold lg:text-sm text-xs">
                  <span class="font-bold capitalize block">Number Of People</span>
                  <span class="font-bold">{{ quoteDetails.no_people }}</span>
                </p>
              </div>
              <div class="w-1/3">
                <p class="font-bold lg:text-sm text-xs">
                  <span class="font-bold capitalize block">Number Of Children</span>
