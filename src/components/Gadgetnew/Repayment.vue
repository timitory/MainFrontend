<template>
  <div>
    <div class="mt-8 px-6 pt-6 lg:px-20 pb-20 relative shadow-lg bg-white whitebox" style="box-shadow: 0px 20px 33px #00000029;">
      <router-link to="/gadget/managegadget" class="absolute left-4 top-2">
...
<!--            <td v-if="enrollee.plan">{{enrollee.plan}}</td>-->
<!--            <td v-else>{{enrollee.plan}}</td>-->
      ...
      <div class="mt-24 ">
        <router-link class="text-green-500 block" to="/gadget/managegadget">Back</router-link>
      </div>
    </div>
