...
<!--                    </div>-->
<!--                    <p class="text-red-500 text-sm mt-2" v-if="error.idVideo">Please upload a valid image file</p>-->
<!--                  </div>-->
<!--                </div>-->
                <!-- <div class="mt-4">
...
export default {
 components: {
    ...
    methods:{
      ...
      // videoUpload(){
      //   this.idVideoName = this.$refs.idVideo.files[0].name
      //   this.error.idVideo = false
      //   let fileToLoad = this.$refs.idVideo.files[0];
      //   let fileReader = new FileReader();
      //   let vm = this
      //   fileReader.onload = function(fileLoadedEvent) {
      //     vm.idImage = fileLoadedEvent.target.result; // <--- data: base64
